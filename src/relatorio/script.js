  ...
  <table>
    ...
    <tr>
      ...
      <td>
        ${
        +J1_tempo >= 60
          ? +J1_tempo - Math.trunc(+J1_tempo / 60) >= 10
      ...
      <td>${
        +J2_f1_tempo >= 60
          ? +J2_f1_tempo - Math.trunc(+J2_f1_tempo / 60) >= 10
            ? Math.trunc(+J2_f1_tempo / 60) +
              ":" +
              Math.trunc(+J2_f1_tempo) -
              Math.trunc(+J2_f1_tempo / 60)
            : Math.trunc(+J2_f1_tempo / 60) +
              ":0" +
              Math.trunc(+J2_f1_tempo) -
      ...
      <td>${
        +J2_f2_tempo >= 60
          ? +J2_f2_tempo - Math.trunc(+J2_f2_tempo / 60) >= 10
            ? Math.trunc(+J2_f2_tempo / 60) +
              ":" +
              Math.trunc(+J2_f2_tempo) -
              Math.trunc(+J2_f2_tempo / 60)
            : Math.trunc(+J2_f2_tempo / 60) +
              ":0" +
              Math.trunc(+J2_f2_tempo) -
      ...
      <td>${
        +J2_f3_tempo >= 60
          ? +J2_f3_tempo - Math.trunc(+J2_f3_tempo / 60) >= 10
            ? Math.trunc(+J2_f3_tempo / 60) +
              ":" +
              Math.trunc(+J2_f3_tempo) -
              Math.trunc(+J2_f3_tempo / 60)
            : Math.trunc(+J2_f3_tempo / 60) +
              ":0" +
              Math.trunc(+J2_f3_tempo) -
      ...
      <td>${
        +J3_tempo >= 60
          ? +J3_tempo - Math.trunc(+J3_tempo / 60) >= 10
            ? Math.trunc(+J3_tempo / 60) +
              ":" +
              Math.trunc(+J3_tempo) -
              Math.trunc(+J3_tempo / 60)
            : Math.trunc(+J3_tempo / 60) +
